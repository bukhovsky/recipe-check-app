...
//the same function but for units instead of gramms
  calculateIngridientsUnits(recipe: string){
    this.recipetext = recipe;
...
//console.log(uniqIngrNamesWeights)
this.ingridientsWithUnits = uniqIngrNamesWeights;
this.ingridientsWereUpdated.emit('Ingridients were updated!');
